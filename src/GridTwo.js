            ...
            <div ref={this.gridRef}>
                <ReactTable
                    columns={[
                        ...
                        // },                
                        {
                            Header: props => <span><i className="fas fa-sort"/> ID Grid2 <i className="fas fa-key"/></span>,
                            accessor: "id",
                            Cell: this.renderCell,
                            },
                        {
                            Header: props => <span><i className="fas fa-sort"/> User Grid2 </span>,
                            accessor: "userId",
                            Cell: this.renderCell,
                        },
                        {
                            Header: props => <span><i className="fas fa-sort"/> Title Grid2 </span>,
                            accessor: "title",
                            Cell: this.renderCell,
                        },
                        {
                            Header: props => <span><i className="fas fa-sort"/> Done Grid2 </span>,
                            accessor: "completed",
                            Cell: this.renderCell,
                        }
                    ]}
